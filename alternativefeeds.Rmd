...
(baseline_2015 <- 
 ...
 (algae_total <- 
     ...
     theme(
       ...
       panel.grid.major.y =  element_line(colour="grey80", linetype=1, size=0.3),
...
(circle_legend <- 
    ggplot()+
    theme_nothing+
    scale_x_continuous(limits=c(0.04,1.4))+
    scale_y_continuous(limits = c(-0.05,1.1))+
    geom_circle(aes(x0=0.55, y0=0.36, r=0.4), colour="grey80")+
    geom_circle(aes(x0=0.55, y0=0.36, r=0.25),colour="grey80")+
    geom_circle(aes(x0=0.55, y0=0.36, r=0.1), colour="grey80")+
    coord_equal()+
    theme(
      plot.margin = unit(c(t=0, l=-0.1, b=-0.15,r=0), "cm")
    )+
    annotate("text", x=c(0.55,0.55,0.55), y=c(0.32,0.18,0.04), label=c("2", "4", "6"), size=2.8)+
    annotate("text", x=0.05, y=0.95, label="Forage fish savings\n(million tonnes)", size=3.1, hjust=0)+
...
legend <- ggarrange(circle_legend,scenario_legend,
                    ...
                    widths=c(0.49,0.25),
                    align = "hv")+
  ggsave("legend2.tiff", device = "tiff", dpi=300, width=6, height=6, units = "cm")
