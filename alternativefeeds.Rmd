...
ggplot(data = fishmeal, aes(x=Replacement, y=FCR))+geom_point(alpha=.7)+geom_line(aes(colour=Feed_general, group=Study_id))+
  facet_grid(rows = vars(Fish_group), cols= vars(Feed_general), scales="free")+
  ggsave("growth_fishmeal.tiff", device="tiff", dpi=150, width=7, height=10)

ggplot(data = fish_oil, aes(x=Replacement, y=FCR, colour=Feed_general))+geom_point(alpha=.7)+
  facet_grid(rows = vars(Fish_group), cols= vars(Feed_general), scales="free")+
  ggsave("growth_fish_oil.tiff", device="tiff", dpi=150, width=7, height=10)
...
ggplot(data = fish_oil, aes(x=Replacement, y=n3n6, colour=Feed_general))+geom_point(alpha=.7)+
  facet_grid(rows = vars(Fish_group), cols= vars(Feed_general), scales="free")+
  ggsave("nutrition_fish_oil.tiff", device="tiff", dpi=150, width=7, height=10)
...
length(unique(fishmeal$Study_id))+
length(unique(fish_oil$Study_id))+
length(unique(complete$Study_id))
