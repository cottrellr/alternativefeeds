...
fed_aqua_diets <- left_join(fed_aqua, diets, by="Species")
names(fed_aqua_diets)

fed_aqua_diets <-fed_aqua_diets[,c(1:9, 11:17)]
...
fed_aqua_diets <-  aggregate(fed_aqua_diets$Value ~ fed_aqua_diets$Species +fed_aqua_diets$Broad_group + fed_aqua_diets$Year + fed_aqua_diets$Life_stage +  fed_aqua_diets$FCR +fed_aqua_diets$Ingredient + fed_aqua_diets$Prop, FUN = sum)

fed_aqua_diets <- fed_aqua_diets[fed_aqua_diets$`fed_aqua_diets$Prop`>0,]


aggregate(fed_aqua_diets$`fed_aqua_diets$Value` ~ fed_aqua_diets$`fed_aqua_diets$Species` +fed_aqua_diets$`fed_aqua_diets$Broad_group` + fed_aqua_diets$`fed_aqua_diets$Life_stage` +  fed_aqua_diets$`fed_aqua_diets$FCR` +fed_aqua_diets$`fed_aqua_diets$Ingredient` + fed_aqua_diets$`fed_aqua_diets$Prop`, FUN = mean)
