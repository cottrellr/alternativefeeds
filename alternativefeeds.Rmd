...
(supply_demand <- 
    ...
    geom_segment(x=2013, xend=2030, y=15078983.9, yend = 15078983.9, colour="dodgerblue", linetype=3, alpha=0.3, arrow = arrow(length = unit(1.5, "mm"), type = "closed"))+
                         #annotate("segment", x=1960, xend=2030.5, y=0, yend = 0, colour="black", linetype=1, size=0.95)+
                         annotate("text", x=2014, y=32e+6, label="Average supply\n1980-2013", size=2.5, hjust=0)+
    annotate("text", x=2031.5, y=15078983.9, label="?", size=3)+
    annotation_custom(anchovy, xmin = 2018, xmax = 2032, ymin=34e+6, ymax=44e+6)+
...
(circle_legend <- 
    ...
    coord_equal()+
    theme(
      plot.margin = unit(c(t=0, l=-0.2, b=-0.1,r=0), "cm")
    )+
    annotate("text", x=c(0.55,0.55,0.55), y=c(0.32,0.18,0.04), label=c("2", "4", "6"), size=2.8)+
    annotate("text", x=0.55, y=0.95, label="Forage fish savings\n(million tonnes)", size=3.1)+
