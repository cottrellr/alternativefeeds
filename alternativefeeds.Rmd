...
feeds$FCR_max <- c(1.8, 1.4, 1.8, 1.5, 1.9, 1.8, 1.7, 1.3, 1.7, 1.7, 7.6)
feeds$FM_min <- c(0.01, 0.02, 0.02, 0.25, 0.05, 0.15, 0.08, 0.08, 0.05, 0.01, 0.1)
feeds$FM_max <- c(0.06, 0.34, 0.05, 0.35, 0.1, 0.25, 0.20, 0.12, 0.25, 0.02, 0.2)
...
for (i in 1:length(fed_aqua_list)){
  for (j in 1:nrow(feeds)){
    ...
    fed_aqua_list[[i]]$fed[fed_aqua_list[[i]]$Broad_group==feeds$Broad_group[j]] <- feeds$Fed_max[j]#runif(1, feeds$Fed_min[j], feeds$Fed_max[j])
    ...
    fed_aqua_list[[i]]$surplus <- fed_aqua_list[[i]]$fo_demand - fed_aqua_list[[i]]$fo_from_fm
...
df <- dplyr::bind_rows(fed_aqua_list)

df$consumption[df$surplus< 0] <- df$fm_biomass[df$surplus< 0]
