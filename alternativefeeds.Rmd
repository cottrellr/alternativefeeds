...
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)
#shrimps_bacteria
plotSmeModel(fit_shrimps_bacteria, xlab="",ylab="",  xaxt="n",showIndividuals=T,  showConfidenceBands=T, col.meanCurve="#0686B8", col=alpha("grey50", 0.5), pch=16, panel.first = c((abline(h=1.05, lty=2, lwd=1, col='grey20')),(abline(v=100, lty=2, lwd=1, col='red'))))
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)
#shrimps yeast
