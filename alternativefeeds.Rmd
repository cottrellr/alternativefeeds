...
length((which((unique(growth_data$Study_id[growth_data$Feed_general=="Yeast"]))%%1==0)==TRUE))/length(which((unique(growth_data$Study_id)%%1==0)==TRUE))
...
#FISHMEAL
#carps and algae
length(unique(fishmeal$Study_id[(!is.na(fishmeal$FM_Replacement)) & fishmeal$Feed_general=="Algae" & fishmeal$Fish_group=="Carps"])) #6

#carps and bacteria 

length(unique(fishmeal$Study_id[(!is.na(fishmeal$FM_Replacement)) & fishmeal$Feed_general=="Bacteria" & fishmeal$Fish_group=="Carps"])) #4

#carps and yeast

length(unique(fishmeal$Study_id[(!is.na(fishmeal$FM_Replacement)) & fishmeal$Feed_general=="Yeast" & fishmeal$Fish_group=="Carps"])) #2

#carps and soy 

length(unique(fishmeal$Study_id[(!is.na(fishmeal$FM_Replacement)) & fishmeal$Feed_general=="Soy" & fishmeal$Fish_group=="Carps"])) #4


#carps and insect

length(unique(fishmeal$Study_id[(!is.na(fishmeal$FM_Replacement)) & fishmeal$Feed_general=="Insect" & fishmeal$Fish_group=="Carps"])) #5
...
#Catfishes and algae
length(unique(fishmeal$Study_id[(!is.na(fishmeal$FM_Replacement)) & fishmeal$Feed_general=="Algae" & fishmeal$Fish_group=="Catfishes"])) #3

#Catfishes and bacteria 

length(unique(fishmeal$Study_id[(!is.na(fishmeal$FM_Replacement)) & fishmeal$Feed_general=="Bacteria" & fishmeal$Fish_group=="Catfishes"])) #0

#Catfishes and yeast

length(unique(fishmeal$Study_id[(!is.na(fishmeal$FM_Replacement)) & fishmeal$Feed_general=="Yeast" & fishmeal$Fish_group=="Catfishes"])) #2

#Catfishes and soy 

length(unique(fishmeal$Study_id[(!is.na(fishmeal$FM_Replacement)) & fishmeal$Feed_general=="Soy" & fishmeal$Fish_group=="Catfishes"])) #10
...
length(unique(fishmeal$Study_id[(!is.na(fishmeal$FM_Replacement)) & fishmeal$Feed_general=="Algae" & fishmeal$Fish_group=="Freshwater fishes"])) #

#Freshwater fishes and bacteria 

length(unique(fishmeal$Study_id[(!is.na(fishmeal$FM_Replacement)) & fishmeal$Feed_general=="Bacteria" & fishmeal$Fish_group=="Freshwater fishes"])) #1

#Freshwater fishes and yeast

length(unique(fishmeal$Study_id[(!is.na(fishmeal$FM_Replacement)) & fishmeal$Feed_general=="Yeast" & fishmeal$Fish_group=="Freshwater fishes"])) #

#Freshwater fishes and soy 

length(unique(fishmeal$Study_id[(!is.na(fishmeal$FM_Replacement)) & fishmeal$Feed_general=="Soy" & fishmeal$Fish_group=="Freshwater fishes"])) #12


#Freshwater fishes and insect

length(unique(fishmeal$Study_id[(!is.na(fishmeal$FM_Replacement)) & fishmeal$Feed_general=="Insect" & fishmeal$Fish_group=="Freshwater fishes"])) #



#Tilapias and algae
length(unique(fishmeal$Study_id[(!is.na(fishmeal$FM_Replacement)) & fishmeal$Feed_general=="Algae" & fishmeal$Fish_group=="Tilapias"])) #7

#Tilapias and bacteria 

length(unique(fishmeal$Study_id[(!is.na(fishmeal$FM_Replacement)) & fishmeal$Feed_general=="Bacteria" & fishmeal$Fish_group=="Tilapias"])) #3

#Tilapias and yeast

length(unique(fishmeal$Study_id[(!is.na(fishmeal$FM_Replacement)) & fishmeal$Feed_general=="Yeast" & fishmeal$Fish_group=="Tilapias"])) #9

#Tilapias and soy 

length(unique(fishmeal$Study_id[(!is.na(fishmeal$FM_Replacement)) & fishmeal$Feed_general=="Soy" & fishmeal$Fish_group=="Tilapias"])) #14


#Tilapias and insect

length(unique(fishmeal$Study_id[(!is.na(fishmeal$FM_Replacement)) & fishmeal$Feed_general=="Insect" & fishmeal$Fish_group=="Tilapias"])) #7




#Shrimps and algae
length(unique(fishmeal$Study_id[(!is.na(fishmeal$FM_Replacement)) & fishmeal$Feed_general=="Algae" & fishmeal$Fish_group=="Shrimps"])) #6

#Shrimps and bacteria 

length(unique(fishmeal$Study_id[(!is.na(fishmeal$FM_Replacement)) & fishmeal$Feed_general=="Bacteria" & fishmeal$Fish_group=="Shrimps"])) #1

#Shrimps and yeast

length(unique(fishmeal$Study_id[(!is.na(fishmeal$FM_Replacement)) & fishmeal$Feed_general=="Yeast" & fishmeal$Fish_group=="Shrimps"])) #1

#Shrimps and soy 

length(unique(fishmeal$Study_id[(!is.na(fishmeal$FM_Replacement)) & fishmeal$Feed_general=="Soy" & fishmeal$Fish_group=="Shrimps"])) #11


#Shrimps and insect

length(unique(fishmeal$Study_id[(!is.na(fishmeal$FM_Replacement)) & fishmeal$Feed_general=="Insect" & fishmeal$Fish_group=="Shrimps"])) #3



#Salmonids and algae
length(unique(fishmeal$Study_id[(!is.na(fishmeal$FM_Replacement)) & fishmeal$Feed_general=="Algae" & fishmeal$Fish_group=="Salmonids"])) #7

#Salmonids and bacteria 

length(unique(fishmeal$Study_id[(!is.na(fishmeal$FM_Replacement)) & fishmeal$Feed_general=="Bacteria" & fishmeal$Fish_group=="Salmonids"])) #

#Salmonids and yeast

length(unique(fishmeal$Study_id[(!is.na(fishmeal$FM_Replacement)) & fishmeal$Feed_general=="Yeast" & fishmeal$Fish_group=="Salmonids"])) #7

#Salmonids and soy 

length(unique(fishmeal$Study_id[(!is.na(fishmeal$FM_Replacement)) & fishmeal$Feed_general=="Soy" & fishmeal$Fish_group=="Salmonids"])) #19


#Salmonids and insect

length(unique(fishmeal$Study_id[(!is.na(fishmeal$FM_Replacement)) & fishmeal$Feed_general=="Insect" & fishmeal$Fish_group=="Salmonids"])) #6
...
length(unique(fishmeal$Study_id[(!is.na(fishmeal$FM_Replacement)) & fishmeal$Feed_general=="Algae" & fishmeal$Fish_group=="Marine fishes"])) #16

#Marine fishes and bacteria 

length(unique(fishmeal$Study_id[(!is.na(fishmeal$FM_Replacement)) & fishmeal$Feed_general=="Bacteria" & fishmeal$Fish_group=="Marine fishes"])) #6

#Marine fishes and yeast

length(unique(fishmeal$Study_id[(!is.na(fishmeal$FM_Replacement)) & fishmeal$Feed_general=="Yeast" & fishmeal$Fish_group=="Marine fishes"])) #1

#Marine fishes and soy 

length(unique(fishmeal$Study_id[(!is.na(fishmeal$FM_Replacement)) & fishmeal$Feed_general=="Soy" & fishmeal$Fish_group=="Marine fishes"])) #142


#Marine fishes and insect

length(unique(fishmeal$Study_id[(!is.na(fishmeal$FM_Replacement)) & fishmeal$Feed_general=="Insect" & fishmeal$Fish_group=="Marine fishes"])) #5
...
text(x=-5, y=1.11, labels = expression(italic("100%  (4)")), cex=1,pos = 4)
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)
#carp_yeast
...
text(x=-5, y=1.8, labels = expression(italic("35%  (4)")), cex=1,pos = 4)
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)
#carp_insects
...
text(x=45, y=2.85, labels = expression(italic("10%  (3)")), cex=1,pos = 4)
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)
#catfish_bacteria
...
text(x=45, y=1.55, labels = expression(italic("10% (1)")), cex=1,pos = 4)
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)
#FW fishes yeast
plot(1, type="n", xlab="", ylab="", xlim=c(0, 100), ylim=c(0,100), xaxt="n", yaxt= "n",bty = "l")+
  abline(0,1, col="grey90")
...
text(x=-5, y=2.3, labels = expression(italic("60%  (7)")), cex=1,pos = 4)
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)
...
text(x=-5, y=2.7, labels = expression(italic("100%  (3)")), cex=1,pos = 4)
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)
#tilapias yeast
...
text(x=-5, y=2.5, labels = expression(italic("40%  (9)")), cex=1,pos = 4)
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)
#tilapias soy
...
text(x=-5, y=2.9, labels = expression(italic("50%  (6)")), cex=1,pos = 4)
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)
#shrimps_bacteria
...
text(x=-5, y=1.13, labels = expression(italic("85%  (1)")), cex=1,pos = 4)
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)
...
text(x=-5, y=1.27, labels = expression(italic("20%  (1)")), cex=1,pos = 4)
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)
#shrimps soy
...
text(x=-5, y=1.27, labels = expression(italic("100%  (11)")), cex=1,pos = 4)
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)
#shrimps_insects
...
text(x=45, y=2.85, labels = expression(italic("30%  (7)")), cex=1,pos = 4)
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)
...
text(x=-5, y=1.37, labels = expression(italic("55%  (7)")), cex=1,pos = 4)
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)
#salmonids soy
...
text(x=-5, y=2, labels = expression(italic("50%  (19)")), cex=1,pos = 4)
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)
#salmonids_insects
...
text(x=-5, y=1.11, labels = expression(italic("100%  (3)")), cex=1,pos = 4)
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)
...
text(x=-5, y=2.34, labels = expression(italic("80%  (16)")), cex=1,pos = 4)
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)
...
text(x=45, y=1.9, labels = expression(italic("10%  (6)")), cex=1,pos = 4)
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)
#marine fishes yeast
...
text(x=-5, y=1.6, labels = expression(italic("75%  (1)")), cex=1,pos = 4)
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)
#marine fishes soy
...
text(x=-5, y=4.2, labels = expression(italic("50%  (142)")), cex=1,pos = 4)
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)
...
plotSmeModel(fit_salmonids_algae, xlab="",ylab="",  xaxt="n",showIndividuals=T,  showConfidenceBands=T, col.meanCurve="#172869", col=alpha("grey50", 0.5), pch=16,yaxt="n", bty = "l", panel.first = c((abline(h=1.05, lty=2, lwd=1, col='grey20')),(abline(v=30, lty=2, lwd=1, col='red'))))
...
plotSmeModel(fit_salmonids_soy, xlab="",ylab="",  xaxt="n",showIndividuals=T,  showConfidenceBands=T, col.meanCurve="#E9B186", col=alpha("grey50", 0.5), pch=16,yaxt="n", bty = "l", panel.first = c((abline(h=1.05, lty=2, lwd=1, col='grey20')),(abline(v=50, lty=2, lwd=1, col='red'))))
text(x=10, y=1.1, labels = expression(bold("0%")), cex=1,pos = 4)
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)
...
plotSmeModel(fit_shrimpy_algae, xlab="",ylab="",  xaxt="n",showIndividuals=T,  showConfidenceBands=T, col.meanCurve="#172869", col=alpha("grey50", 0.5), pch=16,yaxt="n", bty = "l", panel.first = c((abline(h=1.05, lty=2, lwd=1, col='grey20')),(abline(v=30, lty=2, lwd=1, col='red'))))
text(x=10, y=1.1, labels = expression(bold("0%")), cex=1,pos = 4)
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)
...
plotSmeModel(fit_shrimpy_soy, xlab="",ylab="",  xaxt="n",showIndividuals=T,  showConfidenceBands=T, col.meanCurve="#E9B186", col=alpha("grey50", 0.5), pch=16,yaxt="n", bty = "l", panel.first = c((abline(h=1.05, lty=2, lwd=1, col='grey20')),(abline(v=100, lty=2, lwd=1, col='red'))))
text(x=10, y=1.1, labels = expression(bold("0%")), cex=1,pos = 4)
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)
...
plotSmeModel(fit_marinefishes_algae, xlab="",ylab="",  xaxt="n",showIndividuals=T,  showConfidenceBands=T, col.meanCurve="#172869", col=alpha("grey50", 0.5), pch=16,yaxt="n", bty = "l", panel.first = c((abline(h=1.05, lty=2, lwd=1, col='grey20')),(abline(v=80, lty=2, lwd=1, col='red'))))
...
plotSmeModel(fit_marinefishes_soy, xlab="",ylab="",  xaxt="n",showIndividuals=T,  showConfidenceBands=T, col.meanCurve="#E9B186", col=alpha("grey50", 0.5), pch=16,yaxt="n", bty = "l", panel.first = c((abline(h=1.05, lty=2, lwd=1, col='grey20')),(abline(v=50, lty=2, lwd=1, col='red'))))
...
#Shrimps and algae
length(unique(FO$Study_id[(!is.na(FO$FO_replacement)) & FO$Feed_general=="Algae" & FO$Fish_group=="Shrimps"])) #3



#Shrimps and soy 

length(unique(FO$Study_id[(!is.na(FO$FO_replacement)) & FO$Feed_general=="Soy" & FO$Fish_group=="Shrimps"])) #5
...
#Salmonids and algae
length(unique(FO$Study_id[(!is.na(FO$FO_replacement)) & FO$Feed_general=="Algae" & FO$Fish_group=="Salmonids"])) #3


#Salmonids and soy 

length(unique(FO$Study_id[(!is.na(FO$FO_replacement)) & FO$Feed_general=="Soy" & FO$Fish_group=="Salmonids"])) #7
...
#Marine fishes and algae
length(unique(FO$Study_id[(!is.na(FO$FO_replacement)) & FO$Feed_general=="Algae" & FO$Fish_group=="Marine fishes"])) #20


#Marine fishes and soy 

length(unique(FO$Study_id[(!is.na(FO$FO_replacement)) & FO$Feed_general=="Soy" & FO$Fish_group=="Marine fishes"])) #17
...
plotSmeModel(fit_shrimps_soy_n3, xlab="",ylab="", showIndividuals=T, showConfidenceBands=T, yaxt="n", col.meanCurve="#472D7BFF", col=alpha("grey50", 0.5), pch=16, panel.first = c((abline(h=0.95, lty=2, lwd=1, col='black')),(abline(v=32, lty=2, lwd=1, col='black')) ))
...
text(x=-5, y=1.6, labels = "100%  (3)", cex=1,pos = 4)
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)

#Shrimps and soy
plotSmeModel(fit_shrimps_soy_n3, xlab="",ylab="",xaxt="n",yaxt="n", bty = "l", showIndividuals=T, showConfidenceBands=T, col.meanCurve="#E9B186", col=alpha("grey50", 0.5), pch=16, panel.first = c((abline(h=0.95, lty=2, lwd=1, col='black')),(abline(v=32, lty=2, lwd=1, col='red')) ))
text(x=50, y=1.05, labels = "30%  (5)", cex=1,pos = 4)
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)

#Salmonids algae n3
plotSmeModel(fit_salmonids_algae_n3, xlab="",ylab="", xaxt="n",yaxt="n", bty = "l", showIndividuals=T, showConfidenceBands=T, col.meanCurve="#172869", col=alpha("grey50", 0.5), pch=16, panel.first = c((abline(h=0.95, lty=2, lwd=1, col='black')),(abline(v=55, lty=2, lwd=1, col='red')) ))
text(x=50, y=1.08, labels = "55%  (3)", cex=1,pos = 4)
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)

#Salmonids soy n3
plotSmeModel(fit_salmon_soy_n3, xlab="",ylab="",xaxt="n",yaxt="n", bty = "l", showIndividuals=T, showConfidenceBands=T, col.meanCurve="#E9B186", col=alpha("grey50", 0.5), pch=16, panel.first = c((abline(h=0.95, lty=2, lwd=1, col='black')),(abline(v=8, lty=2, lwd=1, col='red')) ))
text(x=50, y=1.05, labels = "10%  (7)", cex=1,pos = 4)
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)
...
text(x=-5, y=2.1, labels = "100%  (20)", cex=1,pos = 4)
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)

#marine fishes and soy
plotSmeModel(fit_marine_soy_n3, xlab="",ylab="", xaxt="n",yaxt="n", bty = "l",showIndividuals=T, showConfidenceBands=T, col.meanCurve="#E9B186", col=alpha("grey50", 0.5), pch=16, panel.first = c((abline(h=0.95, lty=2, lwd=1, col='black')),(abline(v=100, lty=2, lwd=1, col='red')) ))
text(x=-5, y=6.2, labels = "100%  (17)", cex=1,pos = 4)
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)
...
FO_replace <- c("Carps" = 1 , "Catfishes"=1, "FW fishes"=1.42, "Tilapias"=1, "Shrimps"=0, "Salmonids"=0.45, "Marine fishes"= 0, "Eels"=1, "Diadromous fishes"=1, "FW crustaceans"=1, "Tunas" =1,  "Marine crustaceans"=1)
...
#Species optimal use
#same as optimal but only Mapplied to salmon and shrimps
...
#   arrange(-Value) %>%
#   slice(1:10) %>% 
#   filter(!Country %in% LDCs)

#countries_afford <- c(MEDCs, top_producers$Country)

#if using countries use below
# FM_replace <- c("Carps" = 0 , "Catfishes"= 0, "FW fishes"= 0.45, "Tilapias"=0, "Shrimps"=0, "Salmonids"=0, "Marine fishes"=.2, "Eels"=1, "Diadromous fishes"=1, "FW crustaceans"=1, "Tunas" =1,  "Marine crustaceans"=1)
# FO_replace <- c("Carps" = 1 , "Catfishes"=1, "FW fishes"=1.42, "Tilapias"=1, "Shrimps"=0, "Salmonids"=0.45, "Marine fishes"= 0, "Eels"=1, "Diadromous fishes"=1, "FW crustaceans"=1, "Tunas" =1,  "Marine crustaceans"=1)
...
FO_replace <- c("Carps" = 1 , "Catfishes"=1, "FW fishes"=1, "Tilapias"=1, "Shrimps"=0, "Salmonids"=0.45, "Marine fishes"= 1, "Eels"=1, "Diadromous fishes"=1, "FW crustaceans"=1, "Tunas" =1,  "Marine crustaceans"=1)
...
a_test <- bind_rows(lapply(1:dim(na.exclude(fed_aqua_proj))[1], function(target_row_id){
  ...
  temp_df <- bind_rows(lapply(1:500, function(rep_id){
    ...
    #assign consumption parameters
    b <- runif(n = 1, min = a[["FCR_min"]], max = a[["FCR_max"]])  # assign random fcr from group range
    c <- case_when(target_row[["Taxa_adj"]] %in% high_val_spp ~   (runif(n = 1, min = a[["FM_min"]], max = a[["FM_max"]]))*as.numeric(FM_replace[target_row[["Taxa_adj"]]]),
                   TRUE ~ (runif(n = 1, min = a[["FM_min"]], max = a[["FM_max"]])))   # assign random fishmeal inclusion from range and adjust for fish meal replacement if in countries_afford
    
    d <- case_when(target_row[["Taxa_adj"]] %in% high_val_spp ~ runif(n = 1, min = a[["FO_min"]], max = a[["FO_max"]]) *as.numeric(FO_replace[target_row[["Taxa_adj"]]]),
                   TRUE ~ runif(n = 1, min = a[["FO_min"]], max = a[["FO_max"]])) #assign random fish oil inclusion from range and adjust for fish oil replacement if in countries_afford
