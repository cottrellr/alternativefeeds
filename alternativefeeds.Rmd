...
ggplot()+
  data= algae_adj, aes(x = Taxa_adj, y = Adj, fill=Element))+
...
+
  ...
  algae_adj %>% 
    ...
    geom_errorbar(aes(ymin=Adj_Value-Adj_sd, ymax=Adj_Value+Adj_sd),position = position_dodge(.9),  width=.2)+
    scale_fill_manual(values = rev(lacroix_palette("PassionFruit", n=4, "continuous")))+
    theme_pubr()+
    theme(
    ...
    guides(fill=F)+
    labs(x="Algae")+
    ggsave("Savings - algae.tiff", device = "tiff", dpi=300, width=3.6, height=5, units="cm")
