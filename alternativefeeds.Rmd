...
#change code - lines(fs[[i]], lty = "dotted", col=alpha("grey90", 0.5))
...
plotSmeModel(fit_carp_algae, xlab="", ylab="", showIndividuals=F,  showConfidenceBands=T, col.meanCurve="#9E0142", lwd=3, col=alpha("grey50", 0.5), pch=16, panel.first = c((abline(h=1.05, lty=2, lwd=1, col='black')),(abline(v=100, lty=2, lwd=1, col='black')) ))
...
plotSmeModel(fit_carp_bacteria, xlab="",ylab="", showIndividuals=F, showConfidenceBands=T, col.meanCurve="#9E0142", col=alpha("grey50", 0.5), pch=16, panel.first = c((abline(h=1.05, lty=2, lwd=1, col='black')),(abline(v=100, lty=2, lwd=1, col='black')) ))
...
plotSmeModel(fit_carp_yeast, xlab="",ylab="", showIndividuals=F,  showConfidenceBands=T, col.meanCurve='#9E0142', col=alpha("grey50", 0.5), pch=16, panel.first = c((abline(h=1.05, lty=2, lwd=1, col='black')),(abline(v=66, lty=2, lwd=1, col='black')) ))
...
plotSmeModel(fit_carp_soy,xlab="",ylab="", showIndividuals=F,  xaxs="i", showConfidenceBands=T, col.meanCurve='#9E0142', col=alpha("grey50", 0.5), pch=16, panel.first = c((abline(h=1.05, lty=2, lwd=1, col='black')),(abline(v=37, lty=2, lwd=1, col='black'))))
...
plotSmeModel(fit_carp_insects,xlab="",ylab="Relative FCR", showIndividuals=F,  showConfidenceBands=T, col.meanCurve="#9E0142", pch=16, col=alpha("grey50", 0.5),  panel.first = c((abline(h=1.05, lty=2, lwd=1, col='black')),(abline(v=100, lty=2, lwd=1, col='black'))))
...
plotSmeModel(fit_tilapia_soy, xlab="",ylab="", showIndividuals=T,  showConfidenceBands=T, col.meanCurve='#d95f0e', col=alpha("grey50", 0.5), pch=16, panel.first = c((abline(h=1.05, lty=2, lwd=1, col='grey20')),(abline(v=71, lty=2, lwd=1, col='grey20'))))
...
myknots <- seq(min(crustaceans_soy$Replacement), max(crustaceans_soy$Replacement), length.out = 4)[-c(1,4)]
