...
(supply_demand <- 
  ...
  theme_pubr()+
  geom_vline(xintercept=2015, linetype=2, colour="grey80")+
  theme(
...
consumption <- 
  ...
  annotate("text", x=2.5, y=39.5e+6, label="Aquaculture consumption scenarios", size=2.8)
...
ggarrange(supply_demand, consumption, widths = c(1,0.7), nrow=1, ncol=2)+
  annotate("text", x=.665,y=.72, label="Average supply 1980-2015", size=2.5)+
  annotate("text", x=.67,y=.545, label="Average feed use 1980-2013", size=2.5, col= "black")+
