...
(supply_demand <- 
    ...
    scale_x_continuous(breaks = c(1970,1990, 2010, 2030), limits = c(1960,2042), expand = c(0,0))+
                         theme_pubr()+
                         ...
                         theme(
                           ...
                           axis.title.x = element_text(size=9, hjust=0.35),
                           axis.text.y = element_text(size=8),
                           axis.title.y = element_text(size=9)
                         )+
                         annotate("segment", x=2013, xend=2039, y=limit, yend = limit)+
                         annotate("segment", x=2013, xend=2039, y=limit*0.8, yend = limit*0.8, linetype=2)+
                         annotate("segment", x=2013, xend=2013, y=-Inf, yend = Inf, colour="grey80", linetype=2)+
    geom_segment(x=2013, xend=2030, y=15078983.9, yend = 15078983.9, colour="dodgerblue", linetype=1, alpha=0.3, arrow = arrow(length = unit(1.5, "mm"), type = "closed"))+
                         #annotate("segment", x=1960, xend=2030.5, y=0, yend = 0, colour="black", linetype=1, size=0.95)+
                         annotate("text", x=2014, y=31e+6, label="Average supply 1980-2013", size=2, hjust=0)+
    annotate("text", x=2035, y=15078983.9, label="2030?", size=3)+
    annotation_custom(anchovy, xmin = 2018, xmax = 2032, ymin=32e+6, ymax=42e+6)+
                         labs(y=bquote(Forage~fish~biomass~(Tx10^6)))+
                         ggsave("total forage fish landings plot2.tiff", device="tiff", dpi=600, width = 8.9, height=7, units = "cm"))
...
demand_scenarios <- ggplot(data = all_diets_scenarios, aes(x=Scenario, y=reorder(Diet,Value)))+
  ...
  guides(fill=guide_colorbar(barwidth = 0.7, barheight = 5, units="cm"))+
...
ggarrange(supply_demand, demand_scenarios,
          ...
          align = "hv", widths = c(0.52,0.49))+
  ggsave("Figure - supply and demand.tiff", dpi=600, device = "tiff", width = 18, height=7, units="cm")+
  ggsave("Figure - supply and demand.pdf", dpi=600, device = "pdf", width = 18, height=7, units="cm")
