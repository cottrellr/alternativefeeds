...
ggplot(data = fishmeal, aes(x=Replacement, y=FCR))+geom_point(alpha=.3,(aes(colour=Feed_general)))+#geom_line(aes(colour=Feed_general, group=Study_id))+
...
ggplot(data = fish_oil, aes(x=Replacement, y=FCR))+geom_point(alpha=.7,(aes(colour=Feed_general)))+geom_line(aes(colour=Feed_general, group=Study_id))+
  facet_grid(rows = vars(Feed_general), cols= vars(Fish_group), scales="free")+
