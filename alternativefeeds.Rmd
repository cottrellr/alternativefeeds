...
plotSmeModel(fit_tilapia_algae, xlab="",ylab="", showIndividuals=T,  showConfidenceBands=T, col.meanCurve="#172869", col=alpha("grey50", 0.5), pch=16, panel.first = c((abline(h=1.05, lty=2, lwd=1, col='grey20')),(abline(v=40, lty=2, lwd=1, col='grey20'))))
...
#carp_microalgae
plotSmeModel(fit_carp_algae, xlab=F, ylab=F, xaxt="n", showIndividuals=T,  showConfidenceBands=T, col.meanCurve="#172869", lwd=3, col=alpha("grey50", 0.5), pch=16, yaxt="n", bty = "l",  panel.first = c((abline(h=1.05, lty=2, lwd=1, col='black')),(abline(v=100, lty=2, lwd=1, col='red'))))+
text(x=-5, y=1.4, labels = expression(italic("100%  (6)")), cex=1,pos = 4)+
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)

#carps scps
plotSmeModel(fit_carp_scps, xlab="",ylab="",xaxt="n", showIndividuals=T, showConfidenceBands=T, col.meanCurve="#0686B8", col=alpha("grey50", 0.5), pch=16, yaxt="n",bty = "l",  panel.first = c((abline(h=1.05, lty=2, lwd=1, col='black')),(abline(v=66, lty=2, lwd=1, col='red')) ))+
text(x=-5, y=1.11, labels = expression(italic("66%  (4)")), cex=1,pos = 4)+
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)
...
#carp_soy
plotSmeModel(fit_carp_soy,xlab="",ylab="",  xaxt="n",showIndividuals=T,  xaxs="i", showConfidenceBands=T, col.meanCurve="#E9B186", col=alpha("grey50", 0.5), pch=16,yaxt="n",bty = "l",  panel.first = c((abline(h=1.05, lty=2, lwd=1, col='black')),(abline(v=15, lty=2, lwd=1, col='red'))))+
text(x=-5, y=1.8, labels = expression(italic("15%  (4)")), cex=1,pos = 4)+
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)
...
#catfish scps
plotSmeModel(fit_catfish_scps, xlab="",ylab="",  xaxt="n",showIndividuals=T,  showConfidenceBands=T, col.meanCurve="#82CDAA", col=alpha("grey50", 0.5), pch=16,yaxt="n", bty = "l", panel.first = c((abline(h=1.05, lty=2, lwd=1, col='grey20')),(abline(v=100, lty=2, lwd=1, col='red'))))+
...
text(x=60, y=1.55, labels = expression(italic("10% (1)")), cex=1,pos = 4)+
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)
...
#tilapias_scps
plotSmeModel(fit_tilapia_scps, xlab="",ylab="", xaxt="n", showIndividuals=T,  showConfidenceBands=T, col.meanCurve="#0686B8", col=alpha("grey50", 0.5), pch=16,yaxt="n",bty = "l",  panel.first = c((abline(h=1.05, lty=2, lwd=1, col='grey20')),(abline(v=100, lty=2, lwd=1, col='red'))))+
...
#shrimps algae
plotSmeModel(fit_shrimps_algae, xlab="",ylab="", xaxt="n", showIndividuals=T,  showConfidenceBands=T, col.meanCurve="#172869", col=alpha("grey50", 0.5), pch=16,yaxt="n",bty = "l",  panel.first = c((abline(h=1.05, lty=2, lwd=1, col='grey20')),(abline(v=20, lty=2, lwd=1, col='red'))))+
text(x=-5, y=2.9, labels = expression(italic("50%  (6)")), cex=1,pos = 4)+
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)

#shrimps_scps
plotSmeModel(fit_shrimps_scps, xlab="",ylab="",  xaxt="n",showIndividuals=T,  showConfidenceBands=T, col.meanCurve="#0686B8", col=alpha("grey50", 0.5), pch=16,yaxt="n", bty = "l", panel.first = c((abline(h=1.05, lty=2, lwd=1, col='grey20')),(abline(v=20, lty=2, lwd=1, col='red'))))+
text(x=-5, y=1.13, labels = expression(italic("20%  (1)")), cex=1,pos = 4)+
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)
...
#salmonids scps
plotSmeModel(fit_salmon_scps, xlab="",ylab="", xaxt="n", showIndividuals=T,  showConfidenceBands=T, col.meanCurve="#82CDAA", col=alpha("grey50", 0.5), pch=16,yaxt="n", bty = "l", panel.first = c((abline(h=1.05, lty=2, lwd=1, col='grey20')),(abline(v=100, lty=2, lwd=1, col='red'))))+
text(x=-5, y=1.37, labels = expression(italic("100%  (7)")), cex=1,pos = 4)+
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)
...
#marine fishes_scp
plotSmeModel(fit_marine_scps, xlab="",ylab="", xaxt="n", showIndividuals=T,  showConfidenceBands=T, col.meanCurve="#0686B8", col=alpha("grey50", 0.5), pch=16,yaxt="n",bty = "l",  panel.first = c((abline(h=1.05, lty=2, lwd=1, col='grey20')),(abline(v=45, lty=2, lwd=1, col='red'))))+
text(x=45, y=1.9, labels = expression(italic("45%  (6)")), cex=1,pos = 4)+
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)
...
mtext(c("Microalgae", "Bacteria & yeasts", "Insects", "Soy"), side=3, line = 0, outer = T, at=c(.2, .4, .6, .8), cex = 0.8, font=4)
...
mtext(c("Carps", "Catfishes", "FW fishes", "Tilapias",    "Shrimps", "Salmonids","Marine fishes"), side=2, outer = T, line = 0.5,  at=rev(seq(from =.08, to=.94, length.out = 7)), cex = 0.75, font=3)
mtext("Relative feed conversion ratio",side = 2, line=2, outer = T)
mtext(c("Microlgae", "Bacteria and yeasts","Insects", "Soy"), side=3, line = 0, outer = T, at=c(.12, .32, .52, .72, .92), cex = 0.8, font=4)
...
a_test <- bind_rows(lapply(1:dim(na.exclude(prod.aqua))[1], function(target_row_id){
  target_row <- na.exclude(prod.aqua)[target_row_id,]
  temp_df <- bind_rows(lapply(1:500, function(rep_id){
    #isolate each row 
    a <- feeds_as_list[[target_row[["Taxa"]]]] 
    
    #consumption parameters FCR change
    b <- runif(n = 1, min = a[["FCR_min"]], max = a[["FCR_max"]])  # assign random fcr from group range
    c <- mean(c(a[["FM_min"]], a[["FM_max"]]))   # assign random fishmeal inclusion from range 
    d <- mean(c(a[["FO_min"]], a[["FO_max"]]))   #assign random fish oil inclusion from range
    e <- mean(c(a[["Fed_min"]], a[["Fed_max"]]))    #assign random fed proportion from 2015 -2025 range
    
    #Consumption parameters FMFO change
    
    bb <- mean(c(a[["FCR_min"]], a[["FCR_max"]]))  # assign random fcr from group range
    ...
    ee <- mean(c(a[["Fed_min"]], a[["Fed_max"]]))    #assign random fed proportion from 2015 -2025 range
...
write_csv(a_test, "consumption sensitivity analysis.csv")
