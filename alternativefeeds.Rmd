...
mtext(c("Algae", "Bacteria", "Yeast", "Soy", "Insects"), side=3, line = 0, outer = T, at=c(.12, .32, .52, .72, .92), cex = 0.8)
mtext(c("Carps", "Catfishes", "FW fishes", "Tilapias", "Crustaceans", "Diad.fishes", "Salmonids", "Shrimps", "Marine fishes"), side=4, line = 0, outer = T, at=rev(seq(from =.06, to=.95, length.out = 9)), cex = 0.75)
...
mtext("Fish oil replacement (%)", side = 1, line=1, outer = T)
mtext("Relative feed conversion ratio",side = 2, line=.8, outer = T)
mtext(c("Algae", "Yeast", "Soy"), side=3, line = 0, outer = T, at=c(0.2,0.52,0.86), cex = 0.7)
mtext(c( "Catfishes", "FW fishes", "Salmonids", "Shrimps", "Marine fishes"), side=4, line = 0.5, outer = T, at=rev(seq(from =.11, to=.92, length.out = 5)), cex = 0.7)
par(op)
dev.off()
