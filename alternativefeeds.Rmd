...
consumption <- 
  ...
  theme(axis.line.y = element_blank(),
        ...
        plot.margin = unit(c(0.2,.2, 0.2,-.87), "cm"))+
  guides(fill=F)+
  labs(x= paste(sprintf('\u2192'), "   Consumption scenarios"))
  
  

ggarrange(supply_demand, consumption, widths = c(1,0.7), nrow=1, ncol=2)+
  ggsave("Figure 1 new.tiff", device="tiff", dpi=600, width = 11, height=8, units = "cm")+
  ggsave("Figure 1 new.pdf", device="pdf", dpi=600, width = 11, height=8, units = "cm")
