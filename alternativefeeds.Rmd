...
#carp_microalgae
plotSmeModel(fit_carp_algae, xlab=F, ylab=F, xaxt="n", showIndividuals=T,  showConfidenceBands=T, col.meanCurve="#172869", lwd=3, col=alpha("grey50", 0.5), pch=16, yaxt="n", bty = "l",  panel.first = c((abline(h=1.05, lty=2, lwd=1, col='black')),(abline(v=100, lty=2, lwd=1, col='red'))))+
text(x=-5, y=1.4, labels = expression(italic("100%  (10)")), cex=1,pos = 4)+
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)
...
text(x=-5, y=1.11, labels = expression(italic("66%  (2)")), cex=1,pos = 4)+
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)
...
text(x=45, y=1.6, labels = expression(italic("10%  (1)")), cex=1,pos = 4)+
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)
...
#carp_microalgae
plotSmeModel(fit_carp_algae, xlab=F, ylab=F, xaxt="n", showIndividuals=T,  showConfidenceBands=T, col.meanCurve="#172869", lwd=3, col=alpha("grey50", 0.5), pch=16, yaxt="n", bty = "l",  panel.first = c((abline(h=1.05, lty=2, lwd=1, col='black')),(abline(v=100, lty=2, lwd=1, col='red'))))+
text(x=-5, y=1.9, labels = expression(italic("100%  (10)")), cex=1,pos = 4)+
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)
...
#marine fishes macroalgae
plotSmeModel(fit_marine_macroalgae, xlab="",ylab="", xaxt="n", showIndividuals=T,  showConfidenceBands=T, col.meanCurve="#0C95BA", col=alpha("grey50", 0.5), pch=16,yaxt="n", bty = "l", panel.first = c((abline(h=1.05, lty=2, lwd=1, col='grey20')),(abline(v=80, lty=2, lwd=1, col='red'))))+
text(x=40, y=1.12, labels = expression(italic("80%  (2)")), cex=1,pos = 4)+
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)
