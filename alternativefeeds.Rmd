...
fit_marine_fo_insect <- sme(object = marine_fo_insect$FO_response, tme = marine_fo_insect$FM_Replacement, ind = marine_fo_insect$Study_id, criteria = "AICc")#, knots = myknots)#, deltaEM = 0.1)
...
#carp_algae
plotSmeModel(fit_carp_fo_algae, xlab="",ylab="", xaxt="n", showIndividuals=T, showConfidenceBands=F, col.meanCurve="#FDE725FF", col=alpha("grey50", 0.5), pch=16, panel.first = c((abline(v=100, lty=2, lwd=1, col='black')),(abline(h=0, lty=2, lwd=1, col='red')) ))
axis(side=1, at=c(0,50,100), tick = T, tck=-0.05)
#carps bacteria
