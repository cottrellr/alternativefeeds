...
prod.aqua <-
  ...
  mutate(Taxa_adj = case_when(Taxa %in% c("Trouts", "Salmons", "Smelts") ~ "Salmonids",
                              ...
                              Taxa == "Marine crustacean" ~ "Marine crustaceans",
...
sort(unique(prod.aqua$Country))
```


#Fig 1 - all production scenarios 
```{r}
...
feeds_as_list <- split(feeds, feeds$Taxa)
